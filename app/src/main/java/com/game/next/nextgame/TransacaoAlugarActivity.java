...
public class TransacaoAlugarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox = (CheckBox) findViewById(R.id.checkBox_transacao);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (connected) {
                            ...
                            if (checkBox.isChecked()) {
                                ...
                                Toast.makeText(TransacaoAlugarActivity.this, "Você precisa aceitar os termos de uso", Toast.LENGTH_SHORT).show();
                            }

                        } else {
                            Toast.makeText(TransacaoAlugarActivity.this, "Você está desconectado. Por favor se conecte e tente novamente alugar o jogo.", Toast.LENGTH_LONG).show();
                        }
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(TransacaoAlugarActivity.this, "Listener was cancelled", Toast.LENGTH_LONG).show();
                    }
                });
