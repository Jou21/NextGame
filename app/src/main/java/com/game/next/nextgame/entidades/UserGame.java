...
public class UserGame {
    ...
    public String getAddManual() {
        return addManual;
    }

    public void setAddManual(String addManual) {
    ...
    public String getPrecoAluga() {
        return precoAluga;
    }

    public void setPrecoAluga(String precoAluga) {
        this.precoAluga = precoAluga;
    }
