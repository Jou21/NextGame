...
import com.game.next.nextgame.notifications.Token;
import com.game.next.nextgame.adapters.MessageAdapter;
import com.game.next.nextgame.entidades.Chat;
import com.game.next.nextgame.entidades.User;
import com.game.next.nextgame.fragments.APIService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // and this
                startActivity(new Intent(MessageActivity.this, ActivityChat.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                finish();
            }
        });
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, "Escreva alguma coisa para enviar!", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
